...
a functional components accept data and display the data and stateful components implement logic and state.
2. When does a componentWillMount function be called? What about a componentWillUpdate?
after a user clicks a button with that function on it. It will search for an update when the update button was clicked
3. Define stateful logic.
stateful logic is logic that hold values and perform logical operations
4. What are the three step of creating a successful test? What is done in each phase? 
Arrange= Setup the component your testing
Act= Execute your behavior
Assert= Check the response to see if it is what you expect